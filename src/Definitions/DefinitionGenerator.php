...
namespace AluisioPires\SwaggerDocs\Definitions;
 ...
 * @package AluisioPires\SwaggerDocs\Definitions
 */
class DefinitionGenerator {
                ...
                */
                ...
                foreach ($appends->getValue($obj) as $item) {
                    ...
                    if ( ! $reflection->hasMethod($methodeName)) {
                        Log::warning("[AluisioPires\SwaggerDocs] Method $model::$methodeName not found while parsing '$item' attribute");
                        continue;
                    }
