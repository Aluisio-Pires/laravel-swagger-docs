<?php namespace AluisioPires\SwaggerDocs\Responses\SchemaBuilders;

use Illuminate\Support\Str;
use AluisioPires\SwaggerDocs\Responses\SchemaBuilder;

/**
 * Class
 * @package AluisioPires\SwaggerDocs\Responses\SchemaBuilders
 */
