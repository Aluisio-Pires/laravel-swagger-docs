...
use Exception;
use AluisioPires\SwaggerDocs\Exceptions\InvalidDefinitionException;
use ReflectionClass;
...
use AluisioPires\SwaggerDocs\Parameters;
use AluisioPires\SwaggerDocs\DataObjects;
...
use AluisioPires\SwaggerDocs\Definitions\DefinitionGenerator;
use AluisioPires\SwaggerDocs\Exceptions\InvalidAuthenticationFlow;
use AluisioPires\SwaggerDocs\Exceptions\SchemaBuilderNotFound;
...
class Generator {
    ...
    private function generateCustomResponseSchema(string $operation, string $model, string $uri) {
        ...
        try {
            ...
            throw new Exception("SchemaBuilder must implements AluisioPires\SwaggerDocs\Responses\SchemaBuilder interface");
        }
    }
