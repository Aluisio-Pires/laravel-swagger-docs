<?php namespace AluisioPires\SwaggerDocs\Http\Controllers;

use AluisioPires\SwaggerDocs\Generator;
use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use AluisioPires\SwaggerDocs\Formatter;
 ...
 * @package AluisioPires\SwaggerDocs\Http\Controllers
 */
